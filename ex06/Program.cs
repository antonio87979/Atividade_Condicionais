//Classificação de Notas
 //   Objetivo: Aprender a usar múltiplas condições em uma estrutura de 
//decisão.
...
//o Exemplo de Saída: "Excelente", "Boa", "Regular" ou "Baixa"
		...
		else if (nota >=7) {Console.WriteLine("Boa!");
 }
		else if (nota >= 5 ) {Console.WriteLine("Regular.");
 }
		else {Console.WriteLine("Baixa!"); 
 }
